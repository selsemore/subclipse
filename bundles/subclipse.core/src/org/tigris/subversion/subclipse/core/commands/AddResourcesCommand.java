      ...
      try {
            ...
            new IResourceVisitor() {
              public boolean visit(IResource resource) {
                try {
                  ...
                  if ((!mResource.isManaged())
                      && (currentResource.equals(resource) || !mResource.isIgnored())) {
        ...
        throw new SVNException(
            new Status(
                ...
                Policy.bind(
                    "SVNTeamProvider.visitError", new Object[] {resources[i].getFullPath()}),
                e)); //$NON-NLS-1$
      }
    } // for
